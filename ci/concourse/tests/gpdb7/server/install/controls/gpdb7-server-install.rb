...
control 'RPM config files' do
  ...
  # make a change to the config file: greenplum-db-7/greenplum_path.sh
  ...
  # any changes to the installed greenplum-db-7/greenplum_path.sh file shall not be removed.
  ...
  # delete the directory /usr/local/greenplum-db-7.*.*
