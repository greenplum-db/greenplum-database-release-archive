...
push() {
	...
	if [ "${RUN_MODE}" != "prod" ]; then
		./tanzunet_client/gp-tanzunet-client upload --verbose --parent-tanzunet-slug vmware-tanzu-greenplum --metadata "./greenplum-database-release/${TANZUNET_METADATA_FILE}" --search-path ./ --gpdb-version "${GPDB_VERSION}" --debug --dryrun
	else
